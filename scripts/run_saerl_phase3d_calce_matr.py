"""Phase-3d sweep targeting remaining CALCE/MATR failure modes."""
...
def parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Run Phase-3d CALCE/MATR-targeted SAERL sweep.")
    p.add_argument("--dataset-csv", type=str, default="data/training/saerl_phase3d_dataset.csv")
    p.add_argument("--dataset-meta-json", type=str, default="data/training/saerl_phase3d_dataset_meta.json")
    p.add_argument("--split-manifest-json", type=str, default="data/training/saerl_phase3d_splits.json")
    p.add_argument(
        "--cem-profile-json",
        type=str,
        default="configs/saerl_phase3d_cem_profile.json",
        help="CEM target-generation profile used during dataset build.",
    )
    p.add_argument(
        "--family-policy-profile-json",
        type=str,
        default="configs/saerl_phase3d_family_policy_profile.json",
        help="Acceptance-aware objective/family reward shaping profile.",
    )
    p.add_argument(
        "--eval-calibration-json",
        type=str,
        default="configs/saerl_phase3d_eval_calibration.json",
        help="Eval-time family/objective calibration profile for SAERL.",
    )
    p.add_argument("--ensemble-root", type=str, default="models/saerl_phase3d/ensemble")
    p.add_argument("--policy-root", type=str, default="models/saerl_phase3d/policy")
    p.add_argument("--train-reports-root", type=str, default="results/saerl_phase3d/training")
    p.add_argument("--eval-output-root", type=str, default="results/saerl_phase3d/evaluation")
    p.add_argument("--aggregate-output-root", type=str, default="results/saerl_phase3d/aggregate")
    ...
    p.add_argument("--gru-epochs", type=int, default=32)
    p.add_argument("--mlp-epochs", type=int, default=32)
    p.add_argument("--gate-epochs", type=int, default=24)
    p.add_argument("--offline-epochs", type=int, default=28)
    p.add_argument("--online-epochs", type=int, default=16)
...
def main() -> None:
    ...
    for objective in objectives:
        print(f"\n=== Phase-3d training for objective={objective} ===", flush=True)
    ...
    print("\nCompleted Phase-3d CALCE/MATR-targeted sweep.")
